...
<div className="sb-container">
  <div className='sb-section-title'>
    ...
    Now that you know the basics, let's explore other parts of Storybook that will improve your experience. This list is just to get you started. You can custômise Storybook in many ways to fit your needs.
  </div>

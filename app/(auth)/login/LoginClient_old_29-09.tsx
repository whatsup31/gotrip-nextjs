...
export default function LoginClient() {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <button className="button py-20 -dark-1 bg-blue-1 text-white w-100" disabled={loading}>
        {loading ? 'Connexion…' : 'Se connecter'} <div className="icon-arrow-top-right ml-15" />
      </button>
    </form>
  );
}

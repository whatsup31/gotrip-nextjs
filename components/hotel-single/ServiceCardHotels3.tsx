// components/hotel-single/ServiceCardHotels3.jsx
"use client";

import Link from "next/link";

export default function ServiceCardHotels3(props) {
  const {
    title,
  ...
  return (
    <div className="hotelCard -type-3 rounded-4 hover-shadow-1">
      {/* image */}
      ...
      {/* content */}
      <div className="hotelCard__content mt-10 px-10 pb-10">
        {/* localisation */}
        {location ? (
        ...
        <div className="d-flex items-center justify-between mt-12">
          <div className="text-14 text-light-1">
            From <span className="text-16 text-dark-1 fw-700">{priceText}</span>
          </div>

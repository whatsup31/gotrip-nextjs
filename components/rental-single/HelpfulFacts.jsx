    ...
    <>
      <div className="col-lg-4 col-md-6">
        ...
        <div className="mt-30">
          ...
          <div className="row x-gap-50 y-gap-5 pt-10">
            <div className="col-12">
              <div className="text-15">Airport transfer fee: 60 EUR</div>
            </div>
      ...
      <div className="col-lg-4 col-md-6">
        <div className="">
          ...
          <div className="row x-gap-50 y-gap-5 pt-10">
            <div className="col-12">
              <div className="text-15">
                Breakfast charge (unless included in room price): 25 EUR
              </div>
            </div>

            <div className="col-12">
              <div className="text-15">Daily Internet/Wi-Fi fee: 10 EUR</div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-30">
          ...
          <div className="row x-gap-50 y-gap-5 pt-10">
            <div className="col-12">
              <div className="text-15">Daily parking fee: 65 EUR</div>
            </div>
          </div>
        </div>
      </div>
